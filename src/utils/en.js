export default [
    ...
    // },
    {
        ...
        content: {
            description: "A That regional cuisine, with the taste of home cooking.",
    ...
    },
    {
        ...
        content: {
            description: "We are a breakfast and restaurant, open in the morning and in the afternoon by reservation. We serve regional foods and are a totally family-oriented and safe environment!",
...
export const labels = {
    login: {
        ...
        email: 'Email',
        password: 'Password',
        new: 'Are you new in the App ?',
        newContinue: ' Register',
        button: 'Enter',
        or: 'or',
        anonimousLogin: 'Anonymous login',
        forgot: 'Forgot your password ?',
        retrieve: ' Get it back'
    },
    signIn: {
        createAccount: 'Create an account with email and password.',
        email: 'Email',
        password: 'Password',
        confirmPassword: 'Confirm your password',
        acceptTerms: 'I accept the terms of the privacy policy',
        buttonCreate: 'Create account'
    },
    recoverPassword: {
        recover: 'Recover password',
        text: 'Enter password recovery email:',
        email: 'email',
        button: 'Send email'
    },
    quiz: {
        A: {
            count: 'Question 1 of 3',
            text: 'Which of the following activities are you most interested in ?',
            q1: 'kayaking',
            q2: 'A boat tour',
            q3: 'A stroll in a square',
        },
        B: {
            count: 'Question 2 of 3',
            text: 'On a sunny day, which do you prefer ?',
            q1: 'Iced Açaí',
            q2: 'Lemonade',
            q3: 'Ice cream',
        },
        C: {
            count: 'Question 3 of 3',
            text: 'Final question, which kind of music do you prefer ?',
            q1: 'Rock',
            q2: 'National',
            q3: 'Silence',
        }
